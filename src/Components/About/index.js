            ...
            <div class="container pb-1">
                ...
                <div class="row mb-0">
                    <div class="col-12 text-center">
                        <img class="allimages mx-2 my-1" alt="Stefanie whisper" src="https://github.com/stefanieklogan/react_portfolio/blob/master/src/images/left.jpg?raw=true"/>
                            <img class="allimages mx-2 my-1" alt="Stefanie surprise" src="https://github.com/stefanieklogan/react_portfolio/blob/master/src/images/center.jpg?raw=true"/>
